...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    if (isset($_POST['chelner'])){
        $Comenzi->updateStatus($_POST['hidden_id']);
    }
}?>
...
<section class="table-section">
    <div class="container">
        ...
        <div class="row item-to-deliver">
            ...
            <div class="col col-md-2 col-sm-2 col-2 order-md-6 order-5"><button class="btn btn-primary order-add-to-cart" type="submit" name="chelner">Served</button></div>
        </div>
        </form>
        <?php }?>
    </div>
