<?php
session_start();
$con=mysqli_connect('localhost','root','Beniamin07','restaurant');
...
curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyDN1sESAjx4G8Wpa0uCX3V6oYzJskz8hAw&idToken='.$token,
